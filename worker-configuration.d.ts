/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: d5921d33cef6a08cd1e6d69331aa1a4c)
...
interface __BaseEnv_CloudflareBindings {
	...
	CURRENCY_SINGLEFLIGHT: DurableObjectNamespace<import("./src/index").CurrencySingleFlight>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CurrencySingleFlight";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN_URL" | "FACILITATOR_URL" | "PAY_TO">> {}
}
